...
A text file containing over 466k English words for a word-list.
...
-  [words_alpha.txt](words_alpha.txt) contains only [[:alpha:]] words (words that only have letters, no numbers or symbols). If you want a quick solution file choose this.
